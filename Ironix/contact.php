...
// You can include PHP logic for a contact form here if needed in the future
// For now, it's a static page displaying contact information.
...
<head>
  ...
  <title>Contact Us - Ironix Hardware Shop</title>
  ...
  <style>
    ...
    * {
    ...
    nav {
      ...
      transition: background-color 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease; /* Add transition */
    }
    .nav-container {
      max-width: 1200px;
      margin: 0 auto;
    ...
    .footer-container {
      ...
      transition: background-color 0.3s ease, color 0.3s ease, border-top-color 0.3s ease; /* Add transition */
    }
    .footer-section {
      flex: 1;
      min-width: 220px;
    ...
    .form-group textarea {
      ...
      border-radius: 5px;
      font-size: 16px;
      transition: border-color 0.3s ease, background-color 0.3s ease, color 0.3s ease; /* Add transition */
    }
    ...
    /* Dark Mode Styles */
    body.dark-mode {
      background: #1a202c; /* Dark background for the whole page */
      color: #e2e8f0; /* Light text color for the whole page */
    }
    .dark-mode nav {
      background: #2d3748;
    ...
    /* Styles specific to the Contact page in Dark Mode */
    .dark-mode .contact-container {
        background: #2d3748; /* Consistent with blog card background */
        box-shadow: 0 5px 20px rgba(0,0,0,0.2);
        color: #e2e8f0; /* Ensure text color changes */
    }
    ...
    .dark-mode .contact-info p i {
        color: #f5a623; /* Keep accent color for icons */
    }
  ...
  <style>
    /* Dark Mode Styles - Comprehensive for Contact Page */
    body.dark-mode {
      background: #1a202c; /* Dark background for the whole page */
      color: #e2e8f0; /* Light text color for the whole page */
    ...
    .dark-mode .footer-container {
        ...
        color: #e2e8f0;
        border-top-color: #f5a623; /* Use accent color for footer top */
         transition: background-color 0.3s ease, color 0.3s ease, border-top-color 0.3s ease; /* Smooth transition */
    }
    .dark-mode .footer-section h2,
    .dark-mode .footer-section h3 {
        color: #f5a623; /* Use accent color for footer headings */
    ...
    .dark-mode .footer-section ul li a:hover:before {
     ...
     .dark-mode .footer-section.subscribe input[type="email"]::placeholder {
        color: #a0aec0;
     }
     .dark-mode .footer-section.subscribe button {
        background: linear-gradient(135deg, #f5a623 0%, #f39c12 100%); /* Use accent color gradient */
...
<body>
  ...
  <div class="contact-container">
    ...
    <div class="contact-info">
      <p><i class="fas fa-map-marker-alt"></i> 123 Hardware Lane, Tool City, TX 75001</p>
      <p><i class="fas fa-phone"></i> (123) 456-7890</p>
      <p><i class="fas fa-envelope"></i> info@ironixhardware.com</p>
