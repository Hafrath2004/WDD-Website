...
<head>
  <meta charset="UTF-8">
  <title>Admin Register - Ironix Hardware Shop</title>
...
<body>
  <div class="register-container">
    ...
    <?php
    if (isset($_SESSION['admin_registration_error'])) {
      echo '<div class="error-message">' . htmlspecialchars($_SESSION['admin_registration_error']) . '</div>';
      unset($_SESSION['admin_registration_error']);
    }
    if (isset($_SESSION['admin_registration_success'])) {
      echo '<div class="success-message">' . htmlspecialchars($_SESSION['admin_registration_success']) . '</div>';
      unset($_SESSION['admin_registration_success']);
    }
    ?>
    
    <form class="register-form" method="post" action="admin_registration.php">
    ...
    <div class="register-footer">
      Already have an admin account? <a href="admin_login.php">Login</a>
    </div>
  </div>
</body>
</html>
