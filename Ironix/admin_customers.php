...
<head>
  <meta charset="UTF-8">
  <title>Customers Dashboard - Ironix Admin</title>
  ...
  <div class="dashboard-container">
    ...
    <nav class="sidebar">
      ...
      <ul>
        ...
        <li><a href="admin_customers.php" class="active"><i class="fa-solid fa-users"></i> Customers</a></li>
    ...
    <div class="main-content">
      <div class="dashboard-header">
        <div class="welcome">Customers <span style="font-size:1.2em;">👥</span></div>
