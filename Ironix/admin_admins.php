...
<head>
  <meta charset="UTF-8">
  <title>Admins Dashboard - Ironix Admin</title>
  ...
  <div class="dashboard-container">
    ...
    <nav class="sidebar">
      ...
      <ul>
        ...
        <li><a href="admin_admins.php" class="active"><i class="fa-solid fa-user-gear"></i> Admins</a></li>
    ...
    <div class="main-content">
      <div class="dashboard-header">
        <div class="welcome">Admins <span style="font-size:1.2em;">👤⚙️</span></div>
