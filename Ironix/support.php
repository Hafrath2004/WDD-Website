...
<head>
  ...
  <title>Support - Ironix Hardware Shop</title>
  ...
  <style>
    ...
    * {
    ...
    /* Styles specific to the Support page */
    .support-container {
        max-width: 900px;
        margin: 40px auto;
        background: #fff;
  ...
  <style>
    ...
    .dark-mode .support-container {
     ...
     .dark-mode .support-container h1 {
        color: #e2e8f0;
     }
     .dark-mode .support-item {
        background: #4a5568;
        border-bottom-color: #718096;
     }
     .dark-mode .support-item h3 {
        color: #f5a623; /* Use accent color for service titles */
     }
     .dark-mode .support-item p {
        color: #a0aec0;
     }
...
<body>
  ...
  <div class="support-container">
    ...
    <div class="support-info">
      <p>Welcome to our support page. Here you can find resources and ways to get help with our products and services.</p>
      <h3>Frequently Asked Questions</h3>
      <p>Browse our FAQ section to find answers to common questions.</p>
      <h3>Contact Support</h3>
      <p>If you need further assistance, please contact our support team:</p>
      <p><i class="fas fa-envelope"></i> Email: support@ironixhardware.com</p>
      <p><i class="fas fa-phone"></i> Phone: (123) 456-7890 (Available during business hours)</p>
      <h3>Product Manuals & Guides</h3>
      <p>Find detailed manuals and guides for our products.</p>
